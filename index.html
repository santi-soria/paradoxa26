  ...
  <style>
    * {
    ...
    body {
      min-height: 100vh;
      background: #3a6ea5;
      background-image: linear-gradient(to bottom, #6ea2d7 0%, #3a6ea5 45%, #2c5782 100%);
      display: flex;
      align-items: center;
...
<body>
  ...
  <!--
    Hail Ilyich
    user: victor-kazamarov
    employee id: E-2619
    password: moth_26
    status: archived
    remover antes de revision matutina
  -->
