...
<body>
  ...
  <script>
    ...
    loginForm.addEventListener('submit', async function (event) {
      ...
      try {
        const response = await fetch('../../controllers/login_handler.php', {
          method: 'POST',
          body: formData
        });
        ...
        if (result.success) {
          ...
          authMessage.textContent = result.message + ' Redirigiendo al foro...';
          setTimeout(() => { window.location.href = '../home/index.php'; }, 1200);
        } else {
